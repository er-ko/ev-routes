<div x-data="{ open: false, respoOpen() { this.open = window.innerWidth >= 1024 } }" class="mb-4 p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg" x-init="respoOpen()">
	<section class="space-y-6">
		<header class="flex justify-between items-center">
			<h2 class="font-semibold text-xl dark:text-gray-400">{{ __('messages.all_data') }}</h2>
			<button
...
{{-- all data without trailer --}}
<div x-data="{ open: false }" class="garage-car mb-4 p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
	<section class="space-y-6">
		<header class="flex justify-between items-center">
			<h2 class="font-semibold text-xl dark:text-gray-400">{{ __('messages.all_data') .' '. __('messages.without_trailer') }}</h2>
			<button
				type="button" @click="open = !open"
				class="p-2 rounded-lg transition duration-400 text-gray-500 bg-gray-50 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-700 dark:bg-gray-900/50 dark:hover:text-gray-600 dark:hover:bg-gray-900">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" x-show="!open" @click="open = false">
			...
			<table class="w-full dark:text-gray-500">
				<tbody>
					<tr class="hover:cursor-pointer bg-gray-50 hover:bg-gray-50/50 dark:bg-gray-900/50 dark:hover:bg-gray-900/25">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_without_trailer['routes_distance'], 2, '.', ' ') }} <span class="font-normal text-xs">{{ $settings['distance'] }}</span></td>
					</tr>
					<tr class="hover:cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_without_trailer['routes_avg_temp'], 2, '.', ' ') }} <span class="font-normal text-xs">°{{ $settings->temperature }}</span></td>
					</tr>
					<tr class="hover:cursor-pointer bg-gray-50 hover:bg-gray-50/50 dark:bg-gray-900/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_without_trailer['routes_avg_speed'], 2, '.', ' ') }} <span class="font-normal text-xs">{{ $settings->distance == 'mi' ? 'mph' : 'km/h' }}</span></td>
					</tr>
					<tr class="hover:cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_without_trailer['routes_avg_consumption'], 2, '.', ' ') }} <span class="font-normal text-xs">{{ $settings['consumption'] == 'Wh' ? 'Wh/mi' : 'kWh / 100 km' }}</span></td>
					</tr>
					<tr class="hover:cursor-pointer bg-gray-50 hover:bg-gray-50/50 dark:bg-gray-900/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_without_trailer['routes_total_consumption'], 0) }} <span class="font-normal text-xs">kW</span></td>
					</tr>
					<tr class="hover:cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ $all_without_trailer['routes_supplied_energy'] }} <span class="font-normal text-xs">kW</span></td>
					</tr>
				</tbody>
			</table>
		</section>
			...
			<table class="w-full dark:text-gray-500">
				<tbody>
					<tr class="hover:cursor-pointer bg-gray-50 hover:bg-gray-50/50 dark:bg-gray-900/50 dark:hover:bg-gray-900/25">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_with_trailer['routes_distance'], 2, '.', ' ') }} <span class="font-normal text-xs">{{ $settings['distance'] }}</span></td>
					</tr>
					<tr class="hover:cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_with_trailer['routes_avg_temp'], 2, '.', ' ') }} <span class="font-normal text-xs">°{{ $settings->temperature }}</span></td>
					</tr>
					<tr class="hover:cursor-pointer bg-gray-50 hover:bg-gray-50/50 dark:bg-gray-900/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_with_trailer['routes_avg_speed'], 2, '.', ' ') }} <span class="font-normal text-xs">{{ $settings->distance == 'mi' ? 'mph' : 'km/h' }}</span></td>
					</tr>
					<tr class="hover:cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_with_trailer['routes_avg_consumption'], 2, '.', ' ') }} <span class="font-normal text-xs">{{ $settings['consumption'] == 'Wh' ? 'Wh/mi' : 'kWh / 100 km' }}</span></td>
					</tr>
					<tr class="hover:cursor-pointer bg-gray-50 hover:bg-gray-50/50 dark:bg-gray-900/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ number_format($all_with_trailer['routes_total_consumption'], 0) }} <span class="font-normal text-xs">kW</span></td>
					</tr>
					<tr class="hover:cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-900/25">
						<td class="px-4 py-2">
							<span class="flex items-center justify-start">
						...
						<td class="px-4 py-2 font-bold">{{ $all_with_trailer['routes_supplied_energy'] }} <span class="font-normal text-xs">kW</span></td>
					</tr>
				</tbody>
			</table>
		</section>
